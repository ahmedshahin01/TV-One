...
ShowModel oneShowModelFromJson(String str) =>
    ShowModel.fromJson(json.decode(str));

String oneShowModelToJson(ShowModel data) => json.encode(data.toJson());
...
class ShowModel {
   ...
   Links? links;
    ...
    factory ShowModel.fromJson(Map<String, dynamic> json) => ShowModel(
        ...
        averageRuntime: json["averageRuntime"] == null ? null : json["averageRuntime"],
...
class Links {
    ...
    factory Links.fromJson(Map<String, dynamic> json) => Links(
        ...
        previousepisode: json["previousepisode"] == null ? null : Self.fromJson(json["previousepisode"]),
        nextepisode: json["nextepisode"] == null ? null : Self.fromJson(json["nextepisode"]),
    );
...
enum Name { UNITED_STATES, UNITED_KINGDOM, CANADA, FRANCE, JAPAN }
...
enum Timezone { AMERICA_NEW_YORK, EUROPE_LONDON, AMERICA_HALIFAX, EUROPE_PARIS, ASIA_TOKYO }
...
enum Day { MONDAY, TUESDAY, WEDNESDAY, THURSDAY, FRIDAY, SUNDAY, SATURDAY }
...
enum Type { SCRIPTED, REALITY, SPORTS, DOCUMENTARY, VARIETY, TALK_SHOW, ANIMATION, PANEL_SHOW, NEWS }

final typeValues = EnumValues({
    "Animation": Type.ANIMATION,
    "Documentary": Type.DOCUMENTARY,
    "News": Type.NEWS,
    "Panel Show": Type.PANEL_SHOW,
...
List<ShowModel> allshowModelFromJson(String str) =>
    List<ShowModel>.from(json.decode(str).map((x) => ShowModel.fromJson(x)));

String allshowModelToJson(List<ShowModel> data) =>
